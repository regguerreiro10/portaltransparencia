...
class SystemUsers extends TRecord
{
    ...
    public function get_system_saldo_empenho_departamento_system_departamento_to_string()
    {
        ...
        $values = SystemSaldoEmpenhoDepartamento::where('system_users_id', '=', $this->id)->getIndexedArray('system_departamento_id','{system_departamento->id}');
        return implode(', ', $values);
    }
    ...
    public function get_system_saldo_empenho_departamento_system_users_to_string()
    {
        ...
        $values = SystemSaldoEmpenhoDepartamento::where('system_users_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
