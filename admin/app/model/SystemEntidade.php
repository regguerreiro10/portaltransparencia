...
class SystemEntidade extends TRecord
{
    const TABLENAME  = 'system_entidade';
    const PRIMARYKEY = 'id';
    ...
    public function getContas()
    {
        ...
        $criteria->add(new TFilter('system_entidade_id', '=', $this->id));
    ...
    public function get_conta_pessoa_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('pessoa_id','{pessoa->nome}');
    ...
    public function get_conta_tipo_conta_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('tipo_conta_id','{tipo_conta->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_categoria_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('categoria_id','{categoria->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_forma_pagamento_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('forma_pagamento_id','{forma_pagamento->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_system_unit_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_system_departamento_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('system_departamento_id','{system_departamento->id}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_system_entidade_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('system_entidade_id','{system_entidade->id}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_natureza_conta_to_string()
    {
        ...
        $values = Conta::where('system_entidade_id', '=', $this->id)->getIndexedArray('natureza_conta_id','{natureza_conta->id}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(Conta::where('system_entidade_id', '=', $this->id)->first())
        {
