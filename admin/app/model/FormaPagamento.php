...
class FormaPagamento extends TRecord
{
    ...
    public function get_conta_system_unit_to_string()
    {
        ...
        $values = Conta::where('forma_pagamento_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_system_departamento_to_string()
    {
        ...
        $values = Conta::where('forma_pagamento_id', '=', $this->id)->getIndexedArray('system_departamento_id','{system_departamento->id}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_system_entidade_to_string()
    {
        ...
        $values = Conta::where('forma_pagamento_id', '=', $this->id)->getIndexedArray('system_entidade_id','{system_entidade->id}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_natureza_conta_to_string()
    {
        ...
        $values = Conta::where('forma_pagamento_id', '=', $this->id)->getIndexedArray('natureza_conta_id','{natureza_conta->id}');
        return implode(', ', $values);
    }
